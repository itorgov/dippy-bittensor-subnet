...
DEFAULT_MODEL_CACHE_DIR = os.environ.get("EVALUATOR_MODEL_CACHE_DIR", "/home/user/dippy-bittensor-subnet/model_cache_dir")
...
def entry():
    ...
    try:
        ...
        print(f"vibe score: {scores_data.vibe_score}")
